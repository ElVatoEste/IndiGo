  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {/* Header Section */}
        <div className="mb-8">
          <h1 className="text-2xl font-bold text-gray-900 mb-2">Mis Servicios</h1>
          <p className="text-gray-600">Gestiona tus solicitudes de servicio activas</p>
        </div>
        ...
        <div className="mt-8">
          {loading ? (
            ...
            <div className="text-center py-12 bg-white rounded-xl shadow-sm">
              ...
              <h3 className="text-lg font-medium text-gray-900 mb-2">No tienes solicitudes activas</h3>
              <p className="text-gray-700 mb-6">Solicita un nuevo servicio para comenzar</p>
              <button
                onClick={() => setModalOpen(true)}
            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3 text-black">
              {solicitudes.map((sol) => (
                <SolicitudServicioCard
                  ...
                  onVerPostulaciones={sol.estado === "activo" ? () => console.log("Ver postulaciones", sol.id) : undefined}
                />
              ))}
            </div>
          )}
