        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 sm:gap-0 mb-8">
            ...
            <button
              ...
              className="bg-indigo-600 hover:bg-indigo-700 text-white px-4 sm:px-6 py-2.5 sm:py-3 rounded-lg shadow-md text-base sm:text-lg font-medium flex items-center gap-2 transition-all duration-200 hover:shadow-lg w-full sm:w-auto"
            >
              <svg
